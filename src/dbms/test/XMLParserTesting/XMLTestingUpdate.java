...
public class XMLTestingUpdate {
	...
	public void testOne() {
		...
		try {
			...
			resExpected.put("col_4", DatatypeFactory.convertToDataType(10000));
			recordSet.add(new Record(resExpected));
			RecordSet actualRes = xmlParser.select("table_1", columns, null);
	...
	public void testTwo() {
		...
		BackendParserFactory.getFactory().setCurrentParser("xml");
		try {
			xmlParser.createDatabase("test2");
			LinkedHashMap<String, Class<? extends DBDatatype>> passMap = new LinkedHashMap<>();
			passMap.put("col_1", DBString.class);
			passMap.put("col_2", DBString.class);
			passMap.put("col_3", DBString.class);
			...
			xmlParser.update("table_1", values, null, where);
			...
			RecordSet actualRes = xmlParser.select("table_1", columns, where2);
			Iterator<Record> resultSetIt = recordSet.iterator();
			Iterator<Record> actualResultIt = actualRes.iterator();
			while (resultSetIt.hasNext() && actualResultIt.hasNext()) {
//				System.out.println(resultSetIt.next().getRecord() + "    " + actualResultIt.next().getRecord());
	...
	public void testThree() {
		...
		BackendParserFactory.getFactory().setCurrentParser("xml");
		try {
			xmlParser.createDatabase("test3");
			LinkedHashMap<String, Class<? extends DBDatatype>> passMap = new LinkedHashMap<>();
			passMap.put("col_1", DBString.class);
			passMap.put("col_2", DBString.class);
			passMap.put("col_3", DBString.class);
...
//				System.out.println(resultSetIt.next().getRecord() + "    " + actualResultIt.next().getRecord());
	...
	public void testFour() {
		...
		BackendParserFactory.getFactory().setCurrentParser("xml");
		try {
			xmlParser.createDatabase("test4");
			LinkedHashMap<String, Class<? extends DBDatatype>> passMap = new LinkedHashMap<>();
			passMap.put("col_1", DBString.class);
			passMap.put("col_2", DBString.class);
			passMap.put("col_3", DBString.class);
...
//				System.out.println(resultSetIt.next().getRecord() + "    " + actualResultIt.next().getRecord());
	...
	public void testFive() {
		...
		BackendParserFactory.getFactory().setCurrentParser("xml");
		try {
			xmlParser.createDatabase("test5");
			LinkedHashMap<String, Class<? extends DBDatatype>> passMap = new LinkedHashMap<>();
			passMap.put("col_1", DBString.class);
			passMap.put("col_2", DBString.class);
			passMap.put("col_3", DBString.class);
...
//				System.out.println(resultSetIt.next().getRecord() + "    " + actualResultIt.next().getRecord());
	...
	public void testSix() {
		...
		BackendParserFactory.getFactory().setCurrentParser("xml");
		try {
			xmlParser.createDatabase("test6");
			LinkedHashMap<String, Class<? extends DBDatatype>> passMap = new LinkedHashMap<>();
			passMap.put("col_1", DBString.class);
			passMap.put("col_2", DBString.class);
			passMap.put("col_3", DBString.class);
...
//			columns.put("col_3", DatatypeFactory.convertToDataType("changed"));
//			columns.put("col_4", 10000);
			Condition where = new Where("col_1 = 'high'");
			xmlParser.update("table_1", null, columnss, where);
