...
public class BackendParserFactory {
	...
	/**
	 *
	 * @return {@link BackendParserFactory} return static
	 *  instance of factory by
	 *         singleton.
	 */
	 ...
	 * 
	 * @param key
	 *            defines the key of the parser required to be registered.
	 * @param parser
	 *            {@link BackendParser} shows value of the registered class
	 *            type.
	 */
	 ...
	 * 
	 * @param key
	 *            defines the the key of the required parser.
	 * @return {@link BackendParser} reference to the instance of the required
	 *         parser.
	 */
