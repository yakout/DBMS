...
public class SmokeTest {
    ...
    public void testInsertWithColumnNames() throws SQLException {
        ...
        try {
            Statement statement = connection.createStatement();
            statement.execute("CREATE TABLE table_name12(column_name1 varchar, " +
                    "column_name2 int, column_name3 varchar)");
            statement.execute("INSERT INTO table_name12(column_NAME1, COLUMN_name3, column_name2)" +
    ...
    public void testInsertWithWrongColumnNames() throws SQLException {
        ...
        try {
            Statement statement = connection.createStatement();
            statement.execute("CREATE TABLE table_name5(column_name1 varchar, column_name2 int," +
                    " column_name3 varchar)");
            statement.executeUpdate(
                    "INSERT INTO table_name5(invalid_column_name1, column_name3, column_name2)" +
                            " VALUES ('value1', 'value3', 4)");
    ...
    public void testUpdate() throws SQLException {
        ...
        try {
            Statement statement = connection.createStatement();
            statement.execute("CREATE TABLE table_name7(column_name1 varchar, column_name2 " +
            ...
            int count4 = statement.executeUpdate(
                    "UPDATE table_name7 SET column_name1='1111111111', COLUMN_NAME2=2222222" +
                            ", column_name3='333333333'");
    ...
    public void testUpdateEmptyOrInvalidTable() throws SQLException {
        ...
        try {
            Statement statement = connection.createStatement();
            statement.execute("CREATE TABLE table_name9(column_name1 varchar, column_name2" +
                    " int, column_name3 varchar)");
    ...
    public void testConditionalDelete() throws SQLException {
        ...
        try {
            Statement statement = connection.createStatement();
            statement.execute("CREATE TABLE table_name11(column_name1 varchar, column_name2 " +
            ...
            Assert.assertEquals("Insert returned a number != 1", 1, count3);
            int count4 = statement.executeUpdate("DELETE From table_name11  WHERE" +
                    " coLUmn_NAME3>'2011-01-25'");
    ...
    public void testSelect() throws SQLException {
        ...
        try {
            Statement statement = connection.createStatement();
            statement
                    .execute("CREATE TABLE table_name12(column_name1 varchar, column_name2 " +
                            "int, column_name3 varchar)");
            int count1 = statement.executeUpdate(
        ...
        try {
            ...
            int count4 = statement.executeUpdate(
                    "INSERT INTO table_name13(column_name1, COLUMN_NAME3, column_NAME2)" +
                            " VALUES ('value5', 'value6', 6)");
            Assert.assertEquals("Insert returned a number != 1", 1, count4);
            ResultSet result = statement.executeQuery("SELECT column_name1 FROM " +
    ...
    public void testExecute() throws SQLException {
        ...
        try {
            ...
            boolean result2 = statement.execute("SELECT column_name1 FROM table_name13 " +
                    "WHERE coluMN_NAME2 = 8");
            Assert.assertTrue("Wrong return for select existing records", result2);

            boolean result3 = statement.execute("SELECT column_name1 FROM table_name13 " +
    ...
    public void testDistinct() throws SQLException {
        ...
        try {
            ...
            boolean result3 = statement
                    .execute("SELECT DISTINCT column_name2, column_name3" +
                            " FROM table_name13 WHERE coluMN_NAME2 < 5");
        ...
        try {
            ...
            boolean result1 = statement.execute(
                    "INSERT INTO table_name13(column_NAME1, column_name2," +
                            " COLUMN_name3) VALUES ('value1', 4, 'value5')");
            Assert.assertFalse("Wrong return for insert record", result1);
            int count3 = statement.executeUpdate(
                    "INSERT INTO table_name13(column_name1, COLUMN_NAME3, " +
                            "column_NAME2) VALUES ('value2', 'value4', 5)");
            Assert.assertEquals("Insert returned a number != 1", 1, count3);
            int count4 = statement.executeUpdate(
                    "INSERT INTO table_name13(column_name1, COLUMN_NAME3, " +
                            "column_NAME2) VALUES ('value5', 'value6', 6)");
            Assert.assertEquals("Insert returned a number != 1", 1, count4);

            boolean result2 = statement.execute("ALTER TABLE table_name13 " +
                    "ADD column_name4 date");
            Assert.assertFalse("Wrong return for ALTER TABLE", result2);

            boolean result3 = statement.execute("SELECT column_name4 FROM " +
                    "table_name13 WHERE coluMN_NAME2 = 5");
            Assert.assertTrue("Wrong return for select existing records", result3);
            ResultSet res2 = statement.getResultSet();
            int rows2 = 0;
    ...
    public void testUnion() throws SQLException {
        ...
        try {
            ...
            boolean result3 = statement.execute(
                    "SELECT * FROM table_name13 WHERE coluMN_NAME2 = 4 " +
                            "UNION SELECT * FROM table_name13 WHERE coluMN_NAME3 < 'value6'");
    ...
    public void testOrderBy() throws SQLException {
        ...
        try {
            ...
            Assert.assertEquals("Insert returned a number != 1", 1, count4);
            boolean result3 = statement
                    .execute("SELECT column_name3, column_name2 FROM table_name13 " +
            ...
            res2.next();
            Assert.assertTrue(res2.isFirst());
            Assert.assertEquals(4, res2.getInt(1));
            Assert.assertEquals("value5", res2.getString(0));
            res2.next();
            Assert.assertEquals(4, res2.getInt(1));
            Assert.assertEquals("value3", res2.getString(0));
            res2.next();
            Assert.assertEquals(5, res2.getInt(1));
            Assert.assertEquals("value4", res2.getString(0));
            res2.next();
            Assert.assertTrue(res2.isLast());
            Assert.assertEquals(6, res2.getInt(1));
            Assert.assertEquals("value6", res2.getString(0));
            res2.next();
            while (res2.previous()) ;
            res2.afterLast();
            Assert.assertTrue(res2.isAfterLast());
    ...
    public void testUnion2() throws SQLException {
        ...
        try {
            Statement statement = connection.createStatement();
            statement.execute(
                    "CREATE TABLE table_name13(column_name1 varchar, column_name2" +
                            " date, column_name3 varchar)");
            int count1 = statement.executeUpdate(
                    "INSERT INTO table_name13(column_NAME1, COLUMN_name3, column_name2)" +
                            " VALUES ('value1', 'value3', '2011-2-1')");
            Assert.assertEquals("Insert returned a number != 1", 1, count1);
            boolean result1 = statement.execute(
                    "INSERT INTO table_name13(column_NAME1, column_name2, COLUMN_name3) " +
                            "VALUES ('value1', '2011-2-10', 'value5')");
            Assert.assertFalse("Wrong return for insert record", result1);
            int count3 = statement.executeUpdate(
                    "INSERT INTO table_name13(column_name1, COLUMN_NAME3, column_NAME2)" +
                            " VALUES ('value2', 'value4', '2011-12-1')");
            Assert.assertEquals("Insert returned a number != 1", 1, count3);
            int count4 = statement.executeUpdate(
                    "INSERT INTO table_name13(column_name1, COLUMN_NAME3, column_NAME2)" +
                            " VALUES ('value5', 'value6', '2011-2-11')");
            Assert.assertEquals("Insert returned a number != 1", 1, count4);
            statement.close();
        } catch (Throwable e) {
            TestRunner.fail("Failed to test SELECT from table UNION", e);
    ...
    public void testMetaData() throws SQLException {
        ...
        try {
            ...
            Assert.assertEquals("Table Insertion did not return 1", 1, count);
            final ResultSet resultSet = statement.executeQuery("select birth, gRAde, id " +
                    "from tb order by id where birth > '0001-01-01'");
            int rows = 0;
    ...
    public void testOrderBy3() throws SQLException {
        ...
        try {
            ...
            int count1 = statement.executeUpdate(
                    "INSERT INTO table_name13(column_NAME1, COLUMN_name3, column_name2)" +
                            " VALUES ('value1', '2011-12-20', 4)");
            Assert.assertEquals("Insert returned a number != 1", 1, count1);
            boolean result1 = statement.execute(
                    "INSERT INTO table_name13(column_NAME1, column_name2, COLUMN_name3) " +
                            "VALUES ('value1', 4, '2011-12-20')");
            Assert.assertFalse("Wrong return for insert record", result1);
            int count3 = statement.executeUpdate(
                    "INSERT INTO table_name13(column_name1, COLUMN_NAME3, column_NAME2) " +
                            "VALUES ('value1', '2011-12-20', 4)");
    ...
    public void testOrder2() throws SQLException {
        ...
        try {
            ...
            Assert.assertEquals("Insert returned a number != 1", 1, count4);
            boolean result3 = statement
                    .execute("SELECT column_name1 FROM table_name13 ORDER BY " +
